...
//#define CONFIG_EXAMPLES_DIR "TT Bluer"
...
#define STRING_CONFIG_H_AUTHOR "(jmsc, TT Bluer)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
	...
	//Bluer padrão
	#define DEFAULT_Kp_LIST {  8.41,  8.41 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.3, 400, 413 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 42, 0, -0.8 }
